...
export const GESTE_PAR_EXERCICE: Record<string, string> = {
  ...
  "Dips entre deux chaises": "dips-deux-chaises",
  ...
  "Tractions négatives": "traction-negative",
  "Tractions supination": "traction-supination",
  "Tractions pronation": "traction",
  "Tractions prise large": "traction-prise-large",
  ...
  "Dips sur chaise jambes tendues": "dips-jambes-tendues",
  "Extensions triceps au sol": "extension-triceps-sol",
  "Curl à la serviette en auto-résistance": "curl",
  "Tractions supination prise serrée": "traction-supination-serree",
  ...
  "Mollets debout sur une jambe": "mollets-une-jambe",
